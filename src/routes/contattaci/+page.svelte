...
<div class="not-prose border-border mt-6 rounded-3xl border p-5 sm:p-6">
	{#if status.message}
		<p
	...
	{#if status.error}
		<p
			class="border-destructive/30 bg-destructive/10 text-destructive mb-4 rounded-xl border px-3 py-2 text-sm"
		>
			{status.error}
		</p>
	{/if}
